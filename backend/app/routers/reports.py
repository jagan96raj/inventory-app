...
from app.models.entities import BillType
...
def business_summary(
    ...
    return reports.get_business_summary(db, year, month)
...
def dashboard_bundle(
    ...
    return reports.get_dashboard_bundle(
        db, year, month, parse_bill_type(bill_type), group_by
    )
...
def business_compare(
    ...
    return reports.get_business_compare(db, year, month)
...
def daily_bill_amounts(
    ...
    return reports.get_daily_bill_amounts(db, year, month)
...
def bills_by_product(
    ...
    return reports.get_bills_by_product(db, year, month, parse_bill_type(bill_type), group_by)
...
def bills_by_customer(
    ...
    return reports.get_bills_by_customer(db, year, month, parse_bill_type(bill_type), limit)
...
def bills_by_location(
    ...
    return reports.get_bills_by_location(db, year, month, parse_bill_type(bill_type))
...
def bills_export(
    ...
    csv_text = reports.get_bills_export_csv(db, year, month, bt, group_by)
...
def sales_summary(
    ...
    return reports.get_sales_summary(db, year, month)
...
def sales_by_product(
    ...
    return reports.get_sales_by_product(db, year, month, group_by)
...
def sales_by_customer(
    ...
    return reports.get_sales_by_customer(db, year, month, limit)
...
def sales_by_location(
    ...
    return reports.get_sales_by_location(db, year, month)
...
def sales_daily(
    ...
    return reports.get_sales_daily(db, year, month)
...
def sales_compare(
    ...
    return reports.get_sales_compare(db, year, month)
...
def sales_payment_breakdown(
    ...
    return reports.get_sales_payment_breakdown(db, year, month)
...
def sales_delivery_breakdown(
    ...
    return reports.get_sales_delivery_breakdown(db, year, month)
...
def sales_export(
    ...
    csv_text = reports.get_sales_export_csv(db, year, month, group_by)
